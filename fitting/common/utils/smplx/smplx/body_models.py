...
class SMPLX(SMPLH):
    ...
    def forward(
        ...
        leye_pose: Optional[Tensor] = None,
        reye_pose: Optional[Tensor] = None,
        face_offset: Optional[Tensor] = None, # added by Gyeongsik
        joint_offset: Optional[Tensor] = None, # added by Gyeongsik
        locator_offset: Optional[Tensor] = None, # added by Gyeongsik
        return_verts: bool = True,
        return_full_pose: bool = False,
        pose2rot: bool = True,
        ...
        **kwargs
        ...
        # added by Gyeongsik (face_offset)
        if face_offset is None:
            vertices = self.v_template
        else:
            vertices = self.v_template + face_offset
        vertices, joints = lbs(shape_components, full_pose, vertices,
                               shapedirs, self.posedirs,
                               self.J_regressor, joint_offset, locator_offset, self.parents, # added by Gyeongsik (joint_offset and locator_offset)
                               self.lbs_weights, pose2rot=pose2rot,
                               )
